  ...
  return (
    <div className={styles.AboutHero}>
      <p>
        ...
        my passion lies in Front-end Development. The ability to create visually
        appealing and user-friendly interfaces that enhance the user experience
        has always fascinated me.
      </p>
      <p>
        Hello, my name is Kumar Ashish Ranjan and I am a Computer Science and
        Engineering undergraduate from the National Institute of Technology
        Silchar, graduating in the year 2025
      </p>
      <p>
        I believe that front-end development is an art form that requires a
        unique combination of technical skills and creativity. It allows me to
        express my creativity through design and user experience while utilizing
        my technical knowledge to bring those designs to life.
      </p>
